...
if (_ie == true) {
  ...
  document.writeln('<OBJECT classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" WIDTH="500" HEIGHT="500" NAME="fileupload" codebase="http://java.sun.com/update/1.4.2/jinstall-1_4-windows-i586.cab#Version=1,4,0,0">');
...
document.writeln('<PARAM NAME="forward" VALUE="http://www.avocats-montpellier.com/permanence/admin_pp">');

document.writeln('<PARAM NAME="url" VALUE="ftp://ftp-windows.fr.oleane.com">');

document.writeln('<PARAM NAME="param1" VALUE="username">');

document.writeln('<PARAM NAME="value1" VALUE="admweb@ordravo6.fr.fto">');

document.writeln('<PARAM NAME="param2" VALUE="password">');

document.writeln('<PARAM NAME="value2" VALUE="UhyPUk58">');
...
document.writeln('<PARAM NAME="value5" VALUE="upload/vademecum">');   
